				...
				<div className="projects_cntr">
					...
					<div className="project_cntr">
						...
						<ProjectLayout
							img={paint}
							title="Paint-Up"
							desc="기존 'Nomadcoder 강의'의 그림판 프로젝트에서 스스로 더 많은 기능을 추가한 프로젝트입니다. JS를 처음 배웠을 때, 실제로 프로젝트를 만들고 기능을 추가하면서 개발에 대한 흥미를 높이며 더 많은 기술 탐구와 JS에 대한 이해에 대한 필요성을 느끼게 해주는 프로젝트 였습니다."
